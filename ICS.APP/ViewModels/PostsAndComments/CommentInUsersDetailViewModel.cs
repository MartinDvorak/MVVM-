...
{
    public class CommentInUsersDetailViewModel : BaseViewModel.BaseViewModel
    {
        ...
        private void AddCommentHandle(AddCommentUsersMessage addCommentUsersMessage)
        {
            CorrespondingPostModel = addCommentUsersMessage.PostModel;
        ...
        {
            Visibility = false;
            mediator.Send(new CloseCommentWindowUsersMessage());
        }
    }
}
